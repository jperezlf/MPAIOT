...
def showFeatureImportance(model, feature_names):
    ...
    plt.xlabel("Elastic Net Feature Importance")
    plt.show()
...
def run(path_to_project):
    ...
    name = path_to_project + '/algorithms/elasticNet/model/train.dat'
