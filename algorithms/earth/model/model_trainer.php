...
class model_trainer
{
    ...
    private function get_data()
    {
        ...
        $sql = "SELECT id_series, SUBSTRING(date_event, 12, 2) as hour ,SUBSTRING(date_event, 9, 2) as day, SUBSTRING(date_event, 6, 2) as month, season, value
    ...
    {
        array_unshift($data, array("serie", "hour", "day", "month", "season", "value"));
